...
const CGU = () => (
  <div className="cgu">
    <h1 className="cgu__title">Conditions générales d'utilisation</h1>
      <p className="cgu__text">Les présentes conditions générales d'utilisation (dites <strong>« CGU »</strong>) ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services et de définir les conditions d’accès et d’utilisation des services par <strong>« l'Utilisateur »</strong>.
Les présentes CGU sont accessibles sur le site à la rubrique «CGU».
</p>
      <p className="cgu__text">Toute inscription ou utilisation du site implique l'acceptation sans aucune réserve ni restriction des présentes CGU par l’utilisateur. Lors de l'inscription sur le site via le Formulaire d’inscription, chaque utilisateur accepte expressément les présentes CGU en cochant la case précédant le texte suivant : « Je reconnais avoir lu et compris les CGU et je les accepte ».
...
NALA.fr  se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.
</p>
  <h4 className="cgu__title-sub">ARTICLE 1 : Les mentions légales</h4>
...
<h4 className="cgu__title-sub">ARTICLE 2 : Accès au site</h4>
<p className="cgu__text">
Le site NALA.fr  permet à l'Utilisateur un accès gratuit aux services suivants : visionnage contenues non inscrit.
Le site internet propose les services suivants : suivre, aimer, poster contenues.
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de NALA.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.
...
<h4 className="cgu__title-sub">ARTICLE 3 : Collecte des données</h4>
<p className="cgu__text">
...
<h4 className="cgu__title-sub">ARTICLE 5 : Responsabilité</h4>
<p className="cgu__text">
Les sources des informations diffusées sur le site NALA.fr sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site NALA.fr ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.
...
Le site NALA.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.
La responsabilité du site ne peut être engagée en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers.
</p>
<h4 className="cgu__title-sub">ARTICLE 6 : Liens hypertextes</h4>
<p className="cgu__text">
Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site NALA.fr. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
</p>
<h4 className="cgu__title-sub">ARTICLE 7 : Cookies</h4>
<p className="cgu__text">
L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement sur son logiciel de navigation.
Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site NALA.fr. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.
L’information contenue dans les cookies est utilisée pour améliorer le site NALA.fr.
En naviguant sur le site, L’Utilisateur les accepte.
L’Utilisateur pourra désactiver ces cookies par l’intermédiaire des paramètres figurant au sein de son logiciel de navigation.
</p>
<h4 className="cgu__title-sub">ARTICLE 8 : Publication par l’Utilisateur</h4>
<p className="cgu__text">
...
<h4 className="cgu__title-sub">ARTICLE 9 : Droit applicable et juridiction compétente</h4>
<p className="cgu__text">
