...
const CGU = () => (
  <div className="cgu">
    ...
    <h2 className="cgu__title-sub">ARTICLE 3 : Collecte des données</h2>
    <p className="cgu__text">
    ...
    <h2 className="cgu__title-sub">ARTICLE 5 : Responsabilité</h2>
    <p className="cgu__text">
    ...
    <h2 className="cgu__title-sub">ARTICLE 6 : Liens hypertextes</h2>
    <p className="cgu__text">
    ...
    <h2 className="cgu__title-sub">ARTICLE 7 : Cookies</h2>
    <p className="cgu__text">
    ...
    <h2 className="cgu__title-sub">ARTICLE 8 : Publication par l’Utilisateur</h2>
    <p className="cgu__text">
    ...
    <h2 className="cgu__title-sub">ARTICLE 9 : Droit applicable et juridiction compétente</h2>
    <p className="cgu__text">
